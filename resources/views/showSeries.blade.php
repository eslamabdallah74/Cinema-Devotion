        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 :xl:grid-cols-6 gap-12">
                ...
                <div class="game mt-8">
                    ...
                    <a href="{{route('actor.show', $cast['id'])}}" target="_blank" class="block text-xl font-semibold leading-tight hover:text-blue-500 mt-4 transition ease-in-out duration-200">
                       {{$cast['name']}}
                    </a>
