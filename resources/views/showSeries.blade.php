...
@section('content')
    <div class="mt-20 border-b border-gray-800 md:mt-5 movie-info">
        <div class="container flex flex-col px-4 mx-auto md:py-16 md:flex-row">
            @if ($serie['poster_path'])
            <img src="{{'https://image.tmdb.org/t/p/w400/'.$serie['poster_path']}}" class="w-96" alt="Movie Poser">
            @else
            ...
            <div class="relative mt-6 md:ml-24">
                ...
                <span class="top-0 right-0 md:absolute">
                    <div class="my-3 FavSeries md:my-0" id="TEST" data-id="{{$serie['id']}}">
                ...
                <div class="flex flex-wrap mt-3 text-gray-400">
                    ...
                    <span class="text-yellow-300">{{$serie['vote_average'] * 10}}%</span>
                    <span class="mx-1">|</span>
                    <span> {{\carbon\carbon::parse($serie['first_air_date'])->format('M d, Y')  }}</span>
                    <span class="mx-1">|</span>
                </div>
        ...
        <div class="container px-4 py-16 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-6 :xl:grid-cols-6">
                ...
                <div class="mt-8 game">
                    ...
                    <a href="{{route('actor.show', $cast['id'])}}" target="_blank" class="block mt-4 text-xl font-semibold leading-tight transition duration-200 ease-in-out hover:text-blue-500">
                       {{$cast['name']}}
                    </a>
    ...
    <h2 class="pt-4 text-4xl font-semibold text-center uppercase">similar series</h2>
                ...
                <div class="mt-8 game">
                    <div class="relative inline-block">
                        <a href="{{route('showSeries.show', $similartv['id'])}}">
                            <img src="{{'https://image.tmdb.org/t/p/w500/'.$similartv['poster_path']}}" alt="Game Poser" class="transition duration-150 ease-in-out hover:opacity-75">
                        </a>
                    ...
                    <a href="{{route('showSeries.show', $similartv['id'])}}" class="block mt-4 text-base font-semibold leading-tight transition duration-200 ease-in-out hover:text-blue-500">
                        {{$similartv['name']}}
...
@section('js')
    <script>
        $(document).ready(function(){
            // targted button
            $('body').on('click', ".FavSeries" , function(event){
